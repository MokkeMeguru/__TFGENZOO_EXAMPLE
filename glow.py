...
from datasets import load_mnist, load_flower
...
class Task:
    ...
    def load_dataset(self):
        if self.hparams["image_name"] == "mnist":
            (
                self.train_dataset,
                self.valid_dataset,
                self.test_dataset,
    ...
    def setup_optimizer(self):
        self.learning_rate_schedule = transformer_schedule.CustomSchedule(self.pixels)
